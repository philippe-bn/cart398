...
public class Processing_Drum_3ContinuousOutputs extends PApplet {
...
public void updateDrums(float p1, float p2, float p3) {
  hatRow[0] = p1 > 0.01f;
  hatRow[1] = p1 > 0.3f;
  hatRow[2] = p1 > 0.1f;
  hatRow[3] = false;
  ...
  public void settings() {  size(395, 200); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Processing_Drum_3ContinuousOutputs" };
    if (passedArgs != null) {
